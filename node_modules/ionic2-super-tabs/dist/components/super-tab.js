...
var SuperTabComponent = (function (_super) {
    __extends(SuperTabComponent, _super);
    function SuperTabComponent(parent, app, config, plt, el, zone, rnd, cfr, gestureCtrl, transCtrl, errorHandler, linker, _dom, cd) {
    ...
    Object.defineProperty(SuperTabComponent.prototype, "tabTitle", {
    ...
    Object.defineProperty(SuperTabComponent.prototype, "index", {
        // needed to make Ionic Framework think this is a tabs component... needed for Deeplinking
        get: 
        // needed to make Ionic Framework think this is a tabs component... needed for Deeplinking
        function () {
    ...
    Object.defineProperty(SuperTabComponent.prototype, "rootParams", {
        get: function () {
    ...
    Object.defineProperty(SuperTabComponent.prototype, "_tabId", {
        get: function () {
            return this.tabId;
        },
        enumerable: true,
    ...
    Object.defineProperty(SuperTabComponent.prototype, "swipeBackEnabled", {
        get: /**
    ...
    Object.defineProperty(SuperTabComponent.prototype, "_vp", {
        set: /**
           * @hidden
           */
        function (val) {
    ...
    SuperTabComponent.prototype._didEnter = function (view) {
        if (this.loaded) {
            _super.prototype._didEnter.call(this, view);
        }
    };
    SuperTabComponent.prototype._willEnter = function (view) {
        if (this.loaded) {
            _super.prototype._willEnter.call(this, view);
        }
    };
    SuperTabComponent.prototype.ngOnInit = function () {
        this.parent.addTab(this);
    };
    SuperTabComponent.prototype.ngAfterViewInit = function () {
        this.initResolve();
    };
    SuperTabComponent.prototype.ngOnDestroy = function () {
        this.destroy();
    };
    SuperTabComponent.prototype.setActive = function (active) {
        if (active) {
            this.cd.reattach();
    ...
    SuperTabComponent.prototype.load = function (load) {
    ...
    SuperTabComponent.prototype.setBadge = function (value) {
        this.badge = value;
    };
    SuperTabComponent.prototype.clearBadge = function () {
        delete this.badge;
    };
    SuperTabComponent.prototype.increaseBadge = function (increaseBy) {
        if (increaseBy === void 0) { increaseBy = 1; }
        this.badge += increaseBy;
    };
    SuperTabComponent.prototype.decreaseBadge = function (decreaseBy) {
        if (decreaseBy === void 0) { decreaseBy = 1; }
        this.badge = Math.max(0, this.badge - decreaseBy);
    };
    SuperTabComponent.prototype.setWidth = function (width) {
        this.setElementStyle('width', width + 'px');
    };
    SuperTabComponent.prototype.goToRoot = function (opts) {
