...
export declare class SuperTabComponent extends NavControllerBase implements OnInit, AfterViewInit, OnDestroy {
    private linker;
    private _dom;
    private cd;
    /**
     ...
     */
    private initResolve;
    constructor(parent: SuperTabsComponent, app: App, config: Config, plt: Platform, el: ElementRef, zone: NgZone, rnd: Renderer, cfr: ComponentFactoryResolver, gestureCtrl: GestureController, transCtrl: TransitionController, errorHandler: ErrorHandler, linker: DeepLinker, _dom: DomController, cd: ChangeDetectorRef);
